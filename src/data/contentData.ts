...
export const contentData: Record<string, ContentData> = {
  ...
  "section-2-5-use-of-firearm-during-police-operations": {
    ...
    content: [
      "Section 2-5 Use of Firearm During Police Operations",
      "",
      "This section establishes the comprehensive guidelines and procedures for the use of firearms during police operations. It covers when firearms may be used, restrictions on their use, and required procedures after firearm use.",
      "",
      "The section addresses critical aspects of firearm use including:",
      "• Justification requirements for firearm use",
      "• Prohibitions on firing at moving vehicles",
      "• Mandatory incident reporting procedures",
      "• Post-confrontation protocols and requirements",
      "",
      "All personnel must be thoroughly trained in these guidelines and strictly adhere to established protocols to ensure safety, legal compliance, and proper documentation of all firearm-related incidents."
    ],
    page: 13
  },
  "2-11-use-of-firearm-when-justified": {
    ...
    content: [
      ...
      "• One who resorts to self-defense must face a real threat on his/her life",
      ...
      "",
      "Key Principles:",
      "• Firearm use must be justified by imminent danger to life or safety",
      "• Self-defense must meet strict legal requirements",
      "• Warning shots are generally prohibited except in extreme circumstances",
  ...
  "2-12-firing-at-moving-vehicles-is-prohibited": {
    ...
    content: [
      ...
      "",
      "Parameters to Consider When Firing at Moving Vehicles:",
      ...
      "",
      "Key Restrictions:",
      "• Firing at moving vehicles is generally prohibited",
      "• Exception only applies when occupants pose imminent danger",
      "• Firearm use must not create additional danger to the public",
      "• Benefits of firearm use must outweigh risks of non-use",
      "• All three parameters must be carefully evaluated before any action"
    ],
    page: 13
  },
  "2-13-filing-of-an-incident-report-after-the-use-of-firearm": {
    id: "2-13-filing-of-an-incident-report-after-the-use-of-firearm",
    title: "2.13 Filing of an Incident Report After the Use of Firearm",
    chapter: "2.13",
    content: [
      "2.13 Filing of an Incident Report After the Use of Firearm",
      "",
      ...
      "• Incident report must be submitted after any firearm discharge",
      "• Report must outline the circumstances that necessitated firearm use",
      "• Report must be filed with the appropriate authority",
      "• All details must be accurately documented",
      "",
      "Key Elements of the Report:",
      "• Circumstances leading to the confrontation",
      "• Justification for firearm use",
      ...
      "• Provides accountability for all firearm discharges",
      "• Allows for proper review and investigation",
      "• Maintains transparency in police operations"
    ],
    page: 13
  },
  "2-14-procedures-after-an-armed-confrontation": {
    ...
    content: [
      ...
      "• Assess ongoing threats to safety",
      "• Document the scene with photographs",
      "• Provide immediate medical attention to all injured parties",
      "• Isolate suspects to prevent escape or further violence",
      "",
      "Post-Operation Requirements:",
      "• Conduct thorough debriefing of all personnel",
      "• Submit comprehensive after-operations report",
      "• Provide psychological support to all involved personnel",
